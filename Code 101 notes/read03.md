Git stores files in a system made of snapshots. You are able to save your files by "commiting" them, git creates a snapshot of the file and stores a reference to it.
